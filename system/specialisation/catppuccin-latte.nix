  ...
  specialisation.${theme}.configuration = {
    ...
    environment.etc = {
      ...
      "theme-config.qml".text = lib.mkForce ''
        ...
        QtObject {
            readonly property color backgroundColor: "#234687"
        }
      '';
    };
    ...
    home-manager.users.ring = {
      theme.wallpaper = lib.mkForce config.theme.wallpaper-snow;
      ...
      gtk = {
        enable = true;
        theme.name = lib.mkForce "Everforest-Light-BL";
        theme.package = lib.mkForce pkgs.everforest-gtk-theme;
