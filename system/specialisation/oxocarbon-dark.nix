...
in
{
  ...
  specialisation.${theme}.configuration = {
    ...
    home-manager.users.ring = {
      theme.wallpaper = lib.mkForce config.theme.wallpaper-milkyway;
      ...
      gtk = {
        enable = true;
        theme.name = lib.mkForce "Nightfox-Dark";
        theme.package = lib.mkForce pkgs.nightfox-gtk-theme;

        gtk3.extraConfig.gtk-application-prefer-dark-theme = lib.mkForce 1;
        gtk4.extraConfig.gtk-application-prefer-dark-theme = lib.mkForce 1;
      };
    };
